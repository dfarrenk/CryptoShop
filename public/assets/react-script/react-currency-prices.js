...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactCurrencyPrices"] = factory(require("react"));
	else
		root["ReactCurrencyPrices"] = factory(root["React"]);
...
var realtime = function (_Component) {
  ...
  function realtime(props) {
    ...
    _this.updateRate = function () {
      var that = _this;
      setInterval(function () {
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get("https://api.coinmarketcap.com/v1/ticker/?limit=4").then(function (data) {
          console.log(data);
  ...
  realtime.prototype.render = function render() {
